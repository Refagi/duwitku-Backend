...
class SavingController {
  static list = async (c: Context) => {
    ...
    return c.json({
      ...
      message: 'Daftar rencana tabungan berhasil diambil',
      data: { goals },
    })
  }
  ...
  static detail = async (c: Context) => {
    ...
    return c.json({
      status: HttpStatusCodes.OK,
      message: 'Detail rencana tabungan berhasil diambil',
      data: result,
    })
  }
  ...
  static update = async (c: Context) => {
    ...
    return c.json({
      status: HttpStatusCodes.OK,
      message: 'Rencana tabungan berhasil diperbarui',
      data: { goal },
    })
  }
  ...
  static withdraw = async (c: Context) => {
    ...
    return c.json(
      { status: HttpStatusCodes.CREATED, message: 'Dana berhasil ditarik', data: { allocation } },
      HttpStatusCodes.CREATED,
    )
  }
}
